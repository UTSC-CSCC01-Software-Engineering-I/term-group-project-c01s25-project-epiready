...
export default function Home() {
  ...
  return (
    <div className="bg-radial-[at_50%_100%] from-[#5C6C52] to-[#0C0C0C] to-90% h-screen flex flex-col items-center">
      <Navbar currentPage="/" />
      <div
        className={`mt-16 mb-10 h-32 w-32 bg-[url('/src/assets/syringe.png')] bg-contain bg-no-repeat bg-center transition-all duration-900 ease-out ${show ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
      ></div>
      <p
