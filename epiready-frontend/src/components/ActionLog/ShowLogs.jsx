...
export default function ShowLogs(){
    ...
    useEffect(() => {
        setLogs([
            ...
            {type: 4, id: 3, message: "Temperature of shipment 3 has crossed 50 degrees Celsius. Shipment 3 is at a ssevere risk of being spolied."}
        ]);
    }, []);
    ...
    <div style={{backgroundColor: "#004900"}}>
        {logComponent}
    </div>)
}